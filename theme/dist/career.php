...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Sidebar Toggle-->
            <!-- <button class="btn btn-link btn-sm order-1 order-lg-0 ms-5 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button> -->
            <!-- Navbar Search-->
        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">    
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="회원가입.php">SIGN UP</a>
            ...
            <iframe src="https://www.jobkorea.co.kr/recruit/joblist?menucode=duty&dutyCtgr=10016" width="100%" height="100%" width="500px" height="500px">
            </div> -->
            
            
             <div id="layoutSidenav_content" style="position:relative; top:-500px;" >
            <iframe src="https://www.jobkorea.co.kr/recruit/joblist?menucode=duty&dutyCtgr=10016" width="1260" height="15100" maginwidth="0" scrolling="no" >
            </div>
