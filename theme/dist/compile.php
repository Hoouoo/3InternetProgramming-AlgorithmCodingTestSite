...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="welcome.php?user_id=<?php echo $id?>">NAKARACUBAE : 네카라쿠배</a>
            <!-- Sidebar Toggle-->
            <button
                        ...
                        <div id="layoutSidenav_content">
                            <main>
                                <div class="container-fluid px-4">
                                    <h1 class="mt-4"><strong>Result</strong></h1>
                                    <ol class="breadcrumb mb-4">
                                        <li class="breadcrumb-item active">✔ 결과를 확인해보세요</li>
                                    </ol>
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <!-- -->
