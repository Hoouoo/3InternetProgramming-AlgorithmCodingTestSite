...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <form class="form-horizontal" method="POST">
                            <main>
                                <div class="container-fluid px-4">
                                    <h1 class="mt-4"><strong>Probelm Archive</strong></h1>
                                    <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item active">☑️ 문제를 제출해보세요.</li>
                                        </li>
                                        <div class="button-8">
                                                    <div class="eff-8"></div>
                                                    <a href="write.php?write_name=<?php echo $name ?>&user_id=<?php echo $id ?>"> 글 쓰기
                                                    </a>
                                                </div>
                                    </ol>
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <table id="datatablesSimple">
                                                <thead>
                                                    <tr>
                                                        <th><div align="center">문제 번호</th>
                                                        <!-- idx !-->
                                                        <th><div align="center">문제 제목</th>
                                                        <th><div align="center">제출자</th>
                                                        <!-- hit !-->
                                                        <th><div align="center">제출 난이도</th>
                                                        <!-- solved !-->
                                                    </tr>
                                                </thead>
                                                <?php  
	    $stmt = $con->prepare('SELECT * FROM nakaracubae_board ORDER BY idx');
	    $stmt->execute();
       ...
       ?>
                                                <tr>
                                                        <td><div align="center"><?php echo $idx; ?></td>
                                                        <td> <div align="center"><a href="problem.php?problem_title=<?php echo $title ?>&user_id=<?php echo $id ?>"> <?php echo $title ?></a></td>
                                                        <td><div align="center"><?php echo $name; ?></td>
                                                        <td> <div align="center"><?php echo $solved; ?></td>
                                                        <?php
			}
                }
